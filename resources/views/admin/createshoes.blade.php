...
@endif
    <form method="POST" action="{{route('adminShoes.store')}}"  enctype="multipart/form-data">
        @csrf
      ...
      <a href="{{route('adminShoes.index')}}" class="btn btn-dark" style="margin-top: 10px"> back </a> 
</div>
@endsection